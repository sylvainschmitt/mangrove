data {
  ...
  int<lower=0> trait[N] ; // response variable (height, diameter, branches, fruits, or flowers)
...
generated quantities {
  ...
  vector[N] residuals = log(to_vector(trait) + 0.01) - (alpha + beta_nci*nci + beta_density*density + beta_shore*shore + 
